...
std::string get_program_description(const Factory::CommandsDescription& commands_description){ // создает строку с описанием программы на основе переданного описания команд (commands_description).
