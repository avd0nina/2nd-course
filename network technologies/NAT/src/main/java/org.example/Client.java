...
public class Client {
    ...
    public void sendPing(String targetIp) throws IOException {
        ...
        System.out.println("Sending ping to " + targetIp);
        ...
        try {
            ...
            while (client.isConnected()) {
                ...
                if (command.startsWith("PING")) {
                    String targetIp = command.split(" ")[1];
                    client.sendPing(targetIp);
                    
                    if (targetIp.equals("203.0.113.5")) { // попробуем пинговать внешний узел
                        System.out.println("Testing NAT to external node...");
                    }
